...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_FileHandler_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_FileHandler_t qt_meta_stringdata_FileHandler = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_FileHandler[] = {
...
Q_CONSTINIT const QMetaObject FileHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_FileHandler.offsetsAndSizes,
    qt_meta_data_FileHandler,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_FileHandler_t,
        // Q_OBJECT / Q_GADGET
