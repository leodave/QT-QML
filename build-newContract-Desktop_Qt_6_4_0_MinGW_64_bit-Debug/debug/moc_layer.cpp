...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Layer_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Layer_t qt_meta_stringdata_Layer = {
    {
        QT_MOC_LITERAL(0, 5)   // "Layer"
    },
    "Layer"
};
...
Q_CONSTINIT static const uint qt_meta_data_Layer[] = {
...
Q_CONSTINIT const QMetaObject Layer::staticMetaObject = { {
    ...
    qt_meta_stringdata_Layer.offsetsAndSizes,
    qt_meta_data_Layer,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Layer_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Layer, std::true_type>
    >,
    nullptr
} };
