...
Q_CONSTINIT static const qt_meta_stringdata_Thread_t qt_meta_stringdata_Thread = {
    {
        ...
        QT_MOC_LITERAL(7, 11),  // "changeLabel"
        QT_MOC_LITERAL(19, 0),  // ""
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->changeLabel((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Thread::changeLabel; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Thread::changeLabel(const QString & _t1)
{
